...
### Пороги за розподілом Рейлі
```
[34.45457778104517, 52.13040500337155, 69.81864385233901, 92.53198435508351, 191.70049474113844]
```

### Лінгвістичний ряд
Лінгвістичний ряд, отриманий після перетворення числових значень, містить послідовність символів A, B, C, D, E, де:
- A: значення ≤ 34.45
- B: значення ≤ 52.13
- C: значення ≤ 69.82
- D: значення ≤ 92.53
...
Загальна кількість переходів: 3593
- A -> A: 820
- A -> B: 1
- B -> B: 589
- B -> C: 1
...
### Час виконання
- Час виконання програми: 0.10 секунд
- Загальний час виконання (з виводом статистики): 0.22 секунд
...
Порівнюючи результати з реалізацією на ![R]ompare.png), можна зробити наступні висновки:
